/*
셀수있는 수량의 순서있는 열거 또는 어떤 순서를 따르는 요소들의 모음을 튜플이라고 합니다.
n\개의 요소를 가진 튜플은 n-튜플이라고 하며 다음과 같이 표현됩니다.
- (a1, a2, a3, ..., an)
...
튜플이 (2, 1, 3, 4) 인 경우 이는
- {{2}, {2, 1}, {2, 1, 3}, {2, 1, 3, 4}}와 같이 표현될 수 있습니다.

특정 튜플을 표현하는 집합이 담긴 문자열 s가 매개변수로 주어질 때, 
s가 표현하는 튜플을 배열에 담아 return하는 함수를 완성하세요
...
6. return하는 배열의 길이가 1 이상 500 이하인 경우만 입력으로 주어집니다.
